 ...
 *          $Id: ScriptIdTag.java,v 1.3 2004/09/17 10:58:05 rdjbarri Exp $ 
 */
public class ScriptIdTag extends BoundTagBase  {

    protected int writeTagContent(StringBuffer sb, ModelBinding binding, IModelAdapter modelAdapter) throws JspException {
        sb.append(BindingUrlFormatter.createPropertyScriptIdUrl(binding, getPropertyName()));
        return SKIP_BODY;        
    }
