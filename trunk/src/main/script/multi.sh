...
echo -n "Enter the process id (e.g. '1of1' : "
read -e PROCESS


ARGS="interactive=false output=$OUTPUT outputItrDetails=true exp=$EXPERIMENT_FACT lscp=$LANDSCAPE_VIEW_FACT prog=$PROGRESS_FACT planFile=./experiments/$PLAN multipleProcess=$PROCESS"
