...
PROGRESS_FACT=com.ixcode.bugsim.view.experiment.edgeeffect.EdgeEffectProgressFactory
EXPERIMENT_FACT=com.ixcode.bugsim.model.experiment.experiment1c.Experiment1cFactory
LANDSCAPE_VIEW_FACT=com.ixcode.bugsim.view.experiment.experiment1c.Experiment1cLandscapeViewFactory
...
ARGS="interactive=false output=$OUTPUT outputItrDetails=true exp=$EXPERIMENT_FACT lscp=$LANDSCAPE_VIEW_FACT prog=$PROGRESS_FACT trial=$TRIAL"
...
nohup java $VM_ARGS -Dbugsim.exp1c.inputCabbageFilename="/home/rialto2/barritjame/bugsim/input/Field E Levin II 2006 layout.csv" -cp $CPTH com.ixcode.bugsim.BugsimMain  $ARGS
