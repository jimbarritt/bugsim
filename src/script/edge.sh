...
EXPERIMENT_FACT=com.ixcode.bugsim.model.experiment.experiment1a.Experiment1aFactory
LANDSCAPE_VIEW_FACT=com.ixcode.bugsim.view.experiment.SimulationLandscapeViewFactory
...
mail -s "Experiment $EXPERIMENT_FACT Trial: $TRIAL Complete!" jim@planet-ix.com < complete.txt 
