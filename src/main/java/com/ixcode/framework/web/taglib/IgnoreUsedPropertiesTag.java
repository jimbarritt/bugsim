 ...
 *          $Id: IgnoreUsedPropertiesTag.java,v 1.2 2004/09/17 10:58:05 rdjbarri Exp $
 */
public class IgnoreUsedPropertiesTag extends BoundTagBase  {
    ...
    protected int writeTagContent(StringBuffer sb, ModelBinding binding, IModelAdapter modelAdapter) throws JspException {
        ...
        if (PageContextHandler.isPropertyUsed(pageContext, binding, parent.getCurrentPropertyName())) {
            tagResult = SKIP_BODY;
        }
        return tagResult;
    }
