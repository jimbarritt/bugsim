 ...
 */
public class EdgeEffectExperimentProgressPanel extends PropertyGroupPanel {

    public EdgeEffectExperimentProgressPanel(IBugsimExperiment experiment) throws JavaBeanException {
