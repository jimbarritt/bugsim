 ...
 */
public class Experiment2aFactory implements IExperimentFactory {
    ...
    public IExperiment createExperiment(String trialName) {
        ...
        ExperimentPlan plan = Experiment2aFactory.createDefaultPlan(Experiment2aFactory.EXP_2A_NAME);

        addManipulations(Experiment2aTrials.class,  trialName, plan);


        return new Experiment2a(simulation, plan);


    }

    private void addManipulations(Class trialsClass, String trialCode, ExperimentPlan plan) {
        String methodName = Experiment2aFactory.METHOD_STUB +  getTrialName(trialCode);
        try {
...
//        SimulationCategory.addSimulationParameters(plan);
    ...
    public static final String EXP_2A_NAME = "exp02a";
}
