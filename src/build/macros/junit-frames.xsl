...
<xsl:param name="CONFIGURATION">unit.tests</xsl:param>
...
<html>
    <head>
        <title>JUnit results for [<xsl:value-of select="$CONFIGURATION"/>]</title>
    </head>
    <frameset cols="20%,80%">
        <frameset rows="30%,70%">
...
<xsl:template match="testsuites" mode="all.tests">
	...
	<head>
	    <title><xsl:value-of select="$CONFIGURATION"/>: <xsl:value-of select="$title"/></title>
	...
	<body>
	    <!-- <xsl:attribute name="onload">open('allclasses-frame.html','classListFrame')</xsl:attribute> -->
            ...
            <h2>JUnit results for [<xsl:value-of select="$CONFIGURATION"/>]: <xsl:value-of select="$title"/></h2>
...
<xsl:template name="pageHeader">
    <h1>JUnit results for [<xsl:value-of select="$CONFIGURATION"/>]</h1>
    <table width="100%">
    <tr>
        <td align="left"></td>
